...
namespace TestWinfrom
{
    public partial class Form1 : Form
    {
        ...
        public async void SendEamil() {
            // 多个不同域名收件人逗号拼接
            string receivers = "625705479@qq.com,16639421145@163.com";
...
//    @"D:\test\文档.pdf"
//};
            // 使用QQ通道发送，一次性发给qq和163收件人
            var firstconfig = ConfigLoader.LoadEmailChannels().Channels[0];
            EmailSender sender = new EmailSender(firstconfig);
            await sender.SendTemplateMailAsync(receivers, "消息通知", "NotifyEmail.vm", model);
